                ...
                <div class="col-md-7 col-lg-7">
                    ...
                    <ul class="social list-inline list-unstyled">
                    	<?php if ( $speaker_facebook_address ) : ?>
                           <li><a target="_blank" href="<?php echo esc_url($speaker_facebook_address) ?>"><i class="fa fa-2x fa-facebook-square"></i></a></li>
                        <?php endif; ?>

                        <?php if ( $speaker_tw ) : ?>
                           <li><a target="_blank" href="<?php echo esc_url($speaker_tw) ?>"><i class="fa fa-2x fa-twitter-square"></i></a></li>
                        <?php endif; ?>

                        <?php if ( $speaker_googleplus_address ) : ?>
                           <li><a target="_blank" href="<?php echo esc_url($speaker_googleplus_address) ?>"><i class="fa fa-2x fa-google-plus-square"></i></a></li>
                        <?php endif; ?>

                        <?php if ( $speaker_linkedin_address ) : ?>
                           <li><a target="_blank" href="<?php echo esc_url($speaker_linkedin_address) ?>"><i class="fa fa-2x fa-linkedin-square"></i></a></li>
                        <?php endif; ?>

                        <?php if ( $speaker_instagram_address ) : ?>
                           <li><a target="_blank" href="<?php echo esc_url($speaker_instagram_address) ?>"><i class="fa fa-2x fa-instagram"></i></a></li>
                        <?php endif; ?>
