...
<?php if (isset($tc_options['css_editor'])){ ?>
	<style>
		<?php echo esc_attr($tc_options['css_editor']); ?>
	</style>
<?php } ?>

<?php if(isset($tc_options['js_editor'])){ ?>
	<script>
			<?php echo esc_attr($tc_options['js_editor']); ?>
	</script>
<?php } ?>
...
<body <?php body_class(); ?>>
	<div id="content" class="site-content">
        ...
        <!-- PRELOADING --> 
        <?php if (true == $tc_options['preload']): ?>
