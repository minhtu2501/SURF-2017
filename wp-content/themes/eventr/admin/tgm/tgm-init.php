 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme TEXT DOMAIN for publication on ThemeForest
...
add_action( 'tgmpa_register', 'TEXT_DOMAIN_register_required_plugins' );
 ...
 */
function TEXT_DOMAIN_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
            'name'               => 'ThemeCube Shortcodes', 
            'slug'               => 'tc-shortcodes', 
            'source'             => get_template_directory() . '/plugins/tc-shortcodes.zip', 
            'required'           => true, 
        ),
