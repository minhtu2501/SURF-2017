function lshowcaseshortcodegenerate() {
	...
	shortcode.innerHTML = "[show-logos orderby='"+order+"' category='"+category+"' activeurl='"+url+"' style='"+style+"' interface='"+layout+"' tooltip='"+tooltip+"' description='"+description+"' limit='"+limit+"' "+carousel + img_code + "]";
	php.innerHTML = "&lt;?php echo build_lshowcase('"+order+"','"+category+"','"+url+"','"+style+"','"+layout+"','"+tooltip+"','"+description+"','"+limit+"','"+php_carousel+"','"+img_php+"'); ?&gt; ";
